...
static ezv_class_t the_class = {
  ...
  mesh3d_cellmask_reset, // cellmask_reset
  mesh3d_cellmask_set_hidden, // cellmask_set1D_hidden
  mesh3d_cellmask_set_alpha // cellmask_set1D_alpha
};
...
void ezv_mesh3d_object_delete (ezv_ctx_t ctx)
{
  mesh3d_renderer_finalize (ctx);
