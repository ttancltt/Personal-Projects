...
void ezv_palette_free (ezv_palette_t *palette)
{
                                 ...
                                 ezv_palette_name_t name)
{
  ...
  case EZV_PALETTE_TRANSPARENT: {
    vec4 colors[]  = {{1.0f, 0.0f, 0.0f, 0.5f},  // transparent red
                      {0.0f, 1.0f, 1.0f, 0.5f}}; // transparent cyan
    const int size = 2;
  ...
  case EZV_PALETTE_EASYPAP: {
    uint32_t colors[] = {
        ezv_rgb (0xFF, 0xE1, 0x19), // Yellow
        ezv_rgb (0xE6, 0x19, 0x4B), // Red
        ezv_rgb (0x3C, 0xFF, 0x4B), // Green
        ezv_rgb (0x91, 0x1E, 0xB4), // Purple
        ezv_rgb (0x42, 0xD4, 0xF4), // Cyan
        ezv_rgb (0xB0, 0xB0, 0xB0), // Grey
        ezv_rgb (0x43, 0x63, 0xD8), // Blue
        ezv_rgb (0xFA, 0xBE, 0xD4), // Pink
        ezv_rgb (0xFF, 0xFA, 0xC8), // Beige
        ezv_rgb (0xAA, 0xFF, 0xC3), // Mint
        ezv_rgb (0xF5, 0x82, 0x31), // Orange
        ezv_rgb (0xE0, 0x32, 0xE0), // Magenta
        ezv_rgb (0xDC, 0xBE, 0xFF), // Lavender
        ezv_rgb (0x9A, 0x63, 0x24), // Brown
        ezv_rgb (0x30, 0x30, 0xFF), // Navy
        ezv_rgb (0xFB, 0xCE, 0xB1), // Apricot
        ezv_rgb (0xBF, 0xEF, 0x45),  // Lime
        ezv_rgb (0x46, 0x99, 0x90), // Teal
