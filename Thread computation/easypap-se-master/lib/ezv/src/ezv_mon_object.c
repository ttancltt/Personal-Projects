...
static ezv_class_t the_class = {
  ...
  NULL, // screenshot
  NULL, // cellmask_reset
  NULL, // cellmask_set1D_hidden
  NULL // cellmask_set1D_alpha
};
...
void ezv_mon_object_delete (ezv_ctx_t ctx)
{
  mon_renderer_finalize (ctx);
...
unsigned mon_get_color_data_size (ezv_ctx_t ctx)
{
  ...
  return ezv_mon_get_palette_size (mon);
}
