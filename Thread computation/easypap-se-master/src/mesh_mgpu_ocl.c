                                    ...
                                    size_t bytes, size_t offset_in_bytes)
{
  ...
  ocl_check (err, "Failed to write to device buffer");
}
                                    ...
                                    size_t bytes, size_t offset_in_bytes)
{
  ...
  ocl_check (err, "Failed to read from device buffer");
}
...
cl_kernel create_cell_gathering_kernel (void)
{
  ...
  ocl_check (err, "Failed to create 'gather_outgoing_buffer' kernel");
