                                   ...
                                   unsigned patch, unsigned count)
{
  ...
  if (rec->heat_mode)
    color = apply_luminance (rec, (now - rec->pu_stat[who].start_time) * 1024.0f / (float)count, color);
                                   ...
                                   unsigned h)
{
  ...
  if (rec->heat_mode)
    color = apply_luminance (rec, (now - rec->pu_stat[who].start_time) * (32.0f * 32.0f) / (float)(w * h), color);
